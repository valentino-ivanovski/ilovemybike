  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full bg-radial from-white to-[#E9E9E9]">
      ...
      <section className="relative flex flex-col-reverse md:flex-row items-center justify-between w-full h-screen overflow-hidden">
          ...
          >
            <motion.div>
              <Image
                ...
                height={1300}
                quality={100}
                className="w-full h-full object-contain transform md:-translate-x-[20%] md:translate-y-[3%] translate-x-[60%] sm:-translate-y-[20%] sm:translate-x-[20%] -translate-y-[45%] scale-[2.2] sm:scale-[1.2] md:scale-[1.4] [@media_(min-width:444px)_and_(max-width:650px)]:scale-[1.4] [@media_(min-width:444px)_and_(max-width:650px)]:translate-x-[30%] [@media_(min-width:444px)_and_(max-width:650px)]:-translate-y-[28%]"
              />
            </motion.div>
          </motion.div>
        </motion.div>
        ...
        <div className="absolute bottom-6 sm:bottom-5 left-1/2 transform -translate-x-1/2 animate-bounce text-gray-300 text-3xl">
          <IoIosArrowDown />
        </div>
      </section>
