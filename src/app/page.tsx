          ...
          >
            <motion.div>
              <Image
                ...
                height={1300}
                quality={100}
                className="w-full h-full object-contain transform md:-translate-x-[20%] md:translate-y-[3%] sm:-translate-y-[20%] sm:translate-x-[20%] -translate-y-[32.5%] translate-x-[42%] scale-[1.7] sm:scale-[1.2] md:scale-[1.4] [@media_(min-width:444px)_and_(max-width:650px)]:scale-[1.4] [@media_(min-width:444px)_and_(max-width:650px)]:translate-x-[30%] [@media_(min-width:444px)_and_(max-width:650px)]:-translate-y-[28%]"
              />
            </motion.div>
          </motion.div>
        </motion.div>
